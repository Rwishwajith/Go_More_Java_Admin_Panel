...
public class sign extends javax.swing.JFrame {
    ...
    ArrayList<Userrrr> userList(){
        ArrayList<Userrrr> usersList=new ArrayList<>();
        try{
            ...
            Userrrr user;
            while(rs.next()){
                user=new Userrrr(rs.getString("name"),rs.getString("password"),rs.getString("email"),rs.getString("country"));
                usersList.add(user);
            }
        }catch(Exception e){
    ...
    public void display(){
        ArrayList<Userrrr> list=userList();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Go More  Sign Details");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 10, 540, 50));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/go_more/sri-lanka-2017-1566.jpg"))); // NOI18N
